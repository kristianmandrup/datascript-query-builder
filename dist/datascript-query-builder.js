...
/***/ function(module, exports, __webpack_require__) {
	...
	var _query_builder = __webpack_require__(1);
	
	Object.defineProperty(exports, 'QueryBuilder', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_query_builder).default;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _query = __webpack_require__(2);
	
	var _query2 = _interopRequireDefault(_query);
	
	var _pull = __webpack_require__(19);
	...
	var QueryBuilder = function () {
	  function QueryBuilder(entityClass, options) {
	  ...
	  _createClass(QueryBuilder, [{
	    ...
	    key: 'byId',
	    value: function byId(params) {
	      return new _pull2.default(this.entityClass, params).build();
	    }
	  }, {
	    key: 'query',
	    value: function query(params, options) {
	      return new _query2.default(this.entityClass, params, options || this.defaultOptions).build();
	    }
	  }, {
	    key: '_defaultOpts',
	    get: function get() {
	      ...
	      return {
	        ...
	        mapNames: function mapNames(name) {
	          return _this.entityClass + '/' + name;
	        }
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _where = __webpack_require__(7);
	
	var _where2 = _interopRequireDefault(_where);
	
	var _in = __webpack_require__(16);
	...
	var Query = function () {
	  ...
	  function Query(entityClass, q, options) {
	    _classCallCheck(this, Query);
	
	    this.options = options || {};
	    this.entityClass = entityClass;
	    this.q = q;
	    this._where = new _where2.default(this.q, this.queryOptions);
	  }
	  ...
	  _createClass(Query, [{
	    ...
	    value: function build() {
	      ...
	      res.params.getNames = function (mapFn) {
	        mapFn = mapFn || _this.options.mapNames;
	        return mapFn ? res.params.names.map(mapFn) : res.params.names;
	      };
	      res.params.all = _lodash2.default.zip(res.params.getNames(), res.params.values);
	      return res;
	    }
	  }, {
	    key: 'queryOptions',
	    ...
	    key: 'find',
	    get: function get() {
	      return new _find2.default(this.q).build();
	    }
	  }, {
	    key: 'ins',
	    get: function get() {
	      return new _in2.default(this.q, this.queryOptions).build();
	    }
	  }, {
	    key: 'where',
	    get: function get() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // See: Attributes
	...
	var _only = __webpack_require__(5);
	...
	var Find = function () {
	  function Find(params) {
	    ...
	    if ((typeof params === 'undefined' ? 'undefined' : _typeof(params)) === 'object') {
	      params = params.$select ? params.$select : (0, _util.toTupleObjList)(params);
	    }
	    this.params = params;
	    this.selector = new _selector2.default(params);
	  }
	  ...
	  _createClass(Find, [{
	    ...
	    key: 'only',
	    value: function only() {
	      return new _only2.default(this.selector.attrs).build()[':find'];
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	exports.toTupleObjList = toTupleObjList;
	...
	function toArray(obj) {
	  ...
	  var arr = keys.reduce(function (prev, key) {
	    return prev.concat([key, obj[key]]);
	  }, []);
	  return arr;
	}
	
	function toTupleList(obj) {
	  return Object.keys(obj).map(function (key) {
	    return [key, obj[key]];
	  });
	}
	
	function toTupleObjList(obj) {
	  return Object.keys(obj).map(function (key) {
...
/***/ function(module, exports) {
	...
	var Only = function () {
	  ...
	  _createClass(Only, [{
	    ...
	    key: '_filtered',
	    value: function _filtered(attrs) {
	      return attrs.reduce(function (prev, next) {
	        return specialAttrib(next) ? prev : prev.concat([next]);
	      }, []);
	    }
	  }, {
	    key: '_attName',
	    value: function _attName(name) {
	      return specialAttrib(name) ? '' : '?' + name;
	    }
	  }, {
	    key: '_attValue',
	    value: function _attValue(name) {
	    ...
	    get: function get() {
	      ...
	      return this.attrs.map(function (name) {
	        return _this._attValue(name);
	      });
	    }
	  }, {
	    key: '_in',
	    ...
	    get: function get() {
	      ...
	      return this.attrs.map(function (name) {
	        return '?e ' + _this3._attName(name) + ' ' + _this3._attValue(name);
	      });
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var Selector = function () {
	  ...
	  _createClass(Selector, [{
	    key: '_normalize',
	    value: function _normalize(param) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Where = function () {
	  function Where(params, options) {
	    _classCallCheck(this, Where);
	
	    this.options = options;
	    if ((typeof params === 'undefined' ? 'undefined' : _typeof(params)) === 'object') {
	      params = (0, _util.toTupleList)(params);
	    }
	    this.params = params;
	    this.values = [];
	    this.names = new Set();
	  ...
	  _createClass(Where, [{
	    ...
	    value: function build() {
	      ...
	      return this.params.map(function (param) {
	        var builder = _builder2.default.create.apply(_builder2.default, _toConsumableArray(param));
	        builder.options = _this.options;
	        return builder.build(_this);
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clauses = __webpack_require__(9);
	
	var _predicate2 = __webpack_require__(15);
	...
	var Builder = function () {
	  function Builder(name, predicate) {
	  ...
	  _createClass(Builder, [{
	    key: '_extract',
	    value: function _extract(predicate) {
	    ...
	    value: function build(where) {
	      ...
	      var clazz = this.type;
	      var obj = _defineProperty({}, this.name, this.predicate);
	      var inst = clazz.create(obj, where);
	      // inst.setValue = this.setValue;
	...
	Builder.create = function (name, predicate) {
	  if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) === 'object') {
	    var attr = Object.keys(name)[0];
	    var pred = name[attr];
	    var key = Object.keys(pred)[0];
	    var value = pred[key];
	    predicate = _defineProperty({}, key, value);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eq = __webpack_require__(12);
	...
	var _not_eq = __webpack_require__(13);
	
	Object.defineProperty(exports, 'NotEq', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_not_eq).default;
	  }
	});
	
	var _or = __webpack_require__(14);
	...
	var _predicate = __webpack_require__(15);
	
	Object.defineProperty(exports, 'Predicate', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_predicate).default;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Id = function (_Base) {
	  _inherits(Id, _Base);
	
	  // $id: 27
	  // perhaps we could call as: 'People', 27, ie. with class as well?
	
	  function Id(entityClass, id) {
	    _classCallCheck(this, Id);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Id).call(this));
	...
	Id.create = function (entityClass, id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Eq = function (_Base) {
	  _inherits(Eq, _Base);
	
	  // name: 'Alice'
	
	  function Eq(name, value, where) {
	    _classCallCheck(this, Eq);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Eq).call(this, name));
	
	    _this.value = value;
	    if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object') {
	      _this.value = value.eq;
	    }
	    _this._where = where;
	    return _this;
	  }
	...
	exports.default = Eq;
	Eq.create = function (name, value, where) {
	  if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) === 'object') {
	    var key = Object.keys(name)[0];
	    where = value;
	    value = name[key];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotEq = function (_Eq) {
	  ...
	  function NotEq() {
	    ...
	    _classCallCheck(this, NotEq);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(NotEq)).call.apply(_Object$getPrototypeO, [this].concat(args)));
	  }
	...
	exports.default = NotEq;
	
	
	NotEq.create = function (name, value, where) {
	  if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) === 'object') {
	    var key = Object.keys(name)[0];
	    value = name[key].$nin;
	    name = key;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Or = function (_Base) {
	  _inherits(Or, _Base);
	
	  function Or(obj, where) {
	    _classCallCheck(this, Or);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Or).call(this));
	  ...
	  _createClass(Or, [{
	    ...
	    key: 'clause',
	    value: function clause(obj) {
	      return _builder2.default.create(obj).build(this._where);
	    }
	  }, {
	    key: 'where',
	    get: function get() {
	    ...
	    get: function get() {
	      ...
	      var clauses = this.list.reduce(function (prev, next) {
	        var clause = _this2.clause(next);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.predicateMap = undefined;
	...
	var predicateMap = exports.predicateMap = {
	  '$ne': 'not',
	  '$lt': '<',
	  '$lte': '<=',
	  '$gt': '>',
	...
	var Predicate = function (_Base) {
	  _inherits(Predicate, _Base);
	
	  function Predicate(name, predicate, where) {
	    _classCallCheck(this, Predicate);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Predicate).call(this, name));
	
	    var key = Object.keys(predicate)[0];
	    _this.key = key;
	    _this._where = where;
	    _this.value = predicate[key];
	    _this.predicate = predicate;
	    _this.outputPredicate = _this.predicateMap[key];
	    return _this;
	  }
	  ...
	  _createClass(Predicate, [{
	    ...
	    get: function get() {
	      ...
	      var eq = _eq2.default.create(this.name, this.value, this._where);
	...
	Predicate.create = function (name, predicate, where) {
	  var pred;
	  if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) === 'object') {
	    var key = Object.keys(name)[0];
	    where = predicate;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function stringify(val) {
	  return (typeof val === 'undefined' ? 'undefined' : _typeof(val)) === 'object' ? Object.keys(val)[0] : val;
	}
	...
	var In = function () {
	  ...
	  function In(params, options) {
	    _classCallCheck(this, In);
	
	    this.options = options || {};
	    if (!Array.isArray(params)) {
	      params = (0, _util.toTupleObjList)(params);
	    } else {
	  ...
	  _createClass(In, [{
	    ...
	    key: '_paramName',
	    value: function _paramName(param) {
	      var key = (typeof param === 'undefined' ? 'undefined' : _typeof(param)) === 'object' ? Object.keys(param)[0] : param;
	      return specialAttrib(key) ? '' : '?' + key;
	    }
	  }, {
	    key: '_value',
	    value: function _value(param) {
	      return (typeof param === 'undefined' ? 'undefined' : _typeof(param)) === 'object' ? this._objValue(param) : '' + this._format(param);
	    }
	  }, {
	    key: '_format',
	    value: function _format(name) {
	      return specialAttrib(name) ? '' : '?' + name + '-value';
	    }
	    ...
	    key: '_objValue',
	    value: function _objValue(param) {
	      var key = Object.keys(param)[0];
	      var value = param[key];
	      // get value
	    ...
	    get: function get() {
	      ...
	      var params = this.params.map(function (param) {
	        var val = ['' + _this2._paramName(param), _this2._value(param)].join(' ');
	        return val;
	      }).join(' ');
	      return _lodash2.default.trim(params);
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var Pull = function () {
	  function Pull(entityClass, params) {
	  ...
	  _createClass(Pull, [{
	    ...
	    key: 'entityLookupRef',
	    get: function get() {
	      return _defineProperty({}, this.lookupRefName, this.value);
	    }
	  }, {
	    key: 'lookupRefName',
	    get: function get() {
...
/***/ function(module, exports) {
	...
	var Result = function () {
	  ...
	  _createClass(Result, [{
	    ...
	    key: "enrichResult",
	    value: function enrichResult(result, attributes) {
...
;
//# sourceMappingURL=datascript-query-builder.js.map